...
if __name__ == "__main__":
    ...
    sweep_config = {
        'method': 'random',
         'name': 'Serengeti_Train_modelV1_loss_contrastive_32',
    }
    metric = {
        'name': 'loss_val',
        'goal': 'minimize'
            ...
            for epoch in range(num_epochs):
                ...
                if epoch % print_every == 0:
                    ...
                    if epoch_acc_val > acc_best:
                        ...
                        os.makedirs(f'Contrative_32_V1/training_{unique_id}', exist_ok=True)
                        # Save the model parameters within the corresponding directory
                        model_params_path = f'Contrative_32_V1/training_{unique_id}/best_model_params_{num_layers}_{hidden_dim}.pth'
