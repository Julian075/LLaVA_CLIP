...
if __name__ == "__main__":
    ...
    parser.add_argument('--ruta_features_train', type=str,
                        default="Features_LLaVA_CLIP_train_32.pt",
                        help='Training path')
    parser.add_argument('--ruta_features_val', type=str,
                        default="Features_LLaVA_CLIP_val_32.pt",
                        help='Validation path')
    parser.add_argument('--ruta_features_test', type=str,
                        default="Features_LLaVA_CLIP_test_32.pt",
                        help='Test path')
    ...
    sweep_config = {
        'method': 'random',
         'name': 'Serengeti_Train_modelV2_loss_supervised_contrastive_32',
    }
    metric = {
        'name': 'loss_val',
        'goal': 'minimize'
    ...
    def train(config=None):
        ...
        with wandb.init(config=config):
            ...
            text_features=torch.load('Text_features_32.pt')
            ...
            def build_optimizer( optimizer, learning_rate, momentum):
                ...
                params1 = {"params": projection_model.description_encoder.parameters(), "lr": learning_rate,
                           "momentum": momentum}
                params2 = {"params": projection_model.proyection_Img_CLIP.parameters(), "lr": learning_rate,
                           "momentum": momentum}
                params3 = {"params": projection_model.proyection_txt_CLIP.parameters(), "lr": learning_rate,
                           "momentum": momentum}
                params4 = {"params": projection_model.logit_scale_CLIP, "lr": learning_rate, "momentum": momentum}
                params5 = {"params": projection_model.logit_scale_LLaVA, "lr": learning_rate, "momentum": momentum}
            ...
            for epoch in range(num_epochs):
                ...
                with torch.no_grad():
                    ...
                    for batch_val in dataloader_val:
                        ...
                        loss_val, acc_val = projection_model(description_embeddings_val, image_features_val, text_features,
                ...
                if epoch % print_every == 0:
                    ...
                    if epoch_acc_val > acc_best:
                        ...
                        os.makedirs(f'Super_Contrative_32_V2/training_{unique_id}', exist_ok=True)
                        # Save the model parameters within the corresponding directory
                        model_params_path = f'Super_Contrative_32_V2/training_{unique_id}/best_model_params_{num_layers}_{hidden_dim}.pth'
