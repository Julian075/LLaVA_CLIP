...
if __name__ == "__main__":
    ...
    sweep_config = {
        'method': 'random',
         'name': 'Serengeti_Train_modelV2_loss_supervised_contrastive_16',
    }
    metric = {
        'name': 'loss_val',
        'goal': 'minimize'
            ...
            for epoch in range(num_epochs):
                ...
                if epoch % print_every == 0:
                    ...
                    if epoch_acc_val > acc_best:
                        ...
                        os.makedirs(f'Super_Contrative_16_V2/training_{unique_id}', exist_ok=True)
                        # Save the model parameters within the corresponding directory
                        model_params_path = f'Super_Contrative_16_V2/training_{unique_id}/best_model_params_{num_layers}_{hidden_dim}.pth'
